...
```tex
{
  ...
  "quick_build": [
    {
      "name": "Primary Quick Build: pdflatex + biber",
      "primary": true,
  ...
  "builder": "traditional",
  "build_system": "pdflatex -> biber -> pdflatex -> pdflatex",

"texpath": "/Library/TeX/texbin:/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin"
}
```
